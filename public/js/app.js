...
document.addEventListener('DOMContentLoaded', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-1").on("click", function (event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-1").toggleClass("active");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__variable-0").toggleClass("active");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-2").on("click", function (event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-2").toggleClass("active");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__variable-2").toggleClass("active");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-3").on("click", function (event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-3").toggleClass("active");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__variable-3").toggleClass("active");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-4").on("click", function (event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-4").toggleClass("active");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__variable-4").toggleClass("active");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-5").on("click", function (event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-5").toggleClass("active");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__variable-5").toggleClass("active");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-6").on("click", function (event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-6").toggleClass("active");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__variable-6").toggleClass("active");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-7").on("click", function (event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-7").toggleClass("active");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__variable-7").toggleClass("active");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-8").on("click", function (event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-8").toggleClass("active");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__variable-8").toggleClass("active");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-9").on("click", function (event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#arrow-9").toggleClass("active");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter__variable-9").toggleClass("active");
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".show__more, .show__less").on("click", function (event) {
      event.preventDefault();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".filter-show__item").toggleClass("active");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".show__more").toggleClass("active");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".show__less").toggleClass("active");
    });
  });
  var elements = document.querySelectorAll('.label_elements');
  var elementPosition = document.querySelector('#checkBtn');
  var child = document.querySelectorAll('.check__span');
  var heightBtn = 45;
  var heightBtnFloat = parseFloat(heightBtn);
  var formFilter = document.querySelector('#form__filters');
  ...
  formFilter.addEventListener('hover', function (event) {
    var target = event.target;
    var visiblePanel = document.querySelectorAll('.filter_info-panel-wrapper');
